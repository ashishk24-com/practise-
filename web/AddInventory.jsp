...
<div class="active">
    ...
    <%
		...
		String query="select p.pid,i.quantity,p.pname,p.manufacturer,p.mfg,p.exp,p.price,p.image_path from product p,inventory i where p.pid=i.pid and i.sid=?";
		try{
 				...
 				<div class="column">
    				<div class="card">
    					<form action="UpdateInventory.jsp" method="post">
    						<img src="uploads/<%=rs.getString("image_path")%>" width=180 height=200>
